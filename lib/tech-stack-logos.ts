...
const openAi: TechStackLogo = {
  name: "OpenAI",
  hex: "412991",
  viewBox: "235 60 210 210",
...
export const techStackLogos: TechStackLogo[] = [
  fromSimple(siNextdotjs),
  fromSimple(siReact),
  fromSimple(siTypescript),
  fromSimple(siPython),
  fromSimple(siFastapi),
  fromSimple(siAnthropic),
  openAi,
  fromSimple(siGooglecloud),
  fromSimple(siVercel),
  fromSimple(siSupabase),
  fromSimple(siDocker),
  fromSimple(siN8n),
  fromSimple(siCursor),
  fromSimple(siPostgresql),
];
